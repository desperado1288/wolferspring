...
public class AuthenticationController {
    ...
    @RequestMapping(value = RouteConfig.AUTH_URL, method = RequestMethod.POST)
    public String authenticate() {
        return "This is just for in-code-documentation purposes and Rest API reference documentation." +
                "Servlet will never get to this point as Http requests are processed by AuthMainFilter." +
